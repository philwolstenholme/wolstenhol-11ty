  ...
  <pw-section section-key="reading">
    ...
    <div class="relative">
      <svg
        ...
        class="-left-56 absolute hidden w-52 2xl:inline"
        style="top: 380px"
      >
        <path
      ...
      <ul role="list" class="pb-2 gap-5 grid md:grid-cols-2 xl:grid-cols-3 mt-8">
        ...
        <li class="md:hidden no-js:hidden scroll-saver space-y-3" x-data>
          <p class="max-w-md m-auto text-center font-serif">
            There are <span class="font-bold">{{ reading.length - 5 }}</span> more of these. I thought I'd save you some scrolling, but if
            you want you can…
          </p>
          <button
            type="button"
