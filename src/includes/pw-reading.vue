...
<template>
  <pw-section section-key="reading">
    ...
    <ul role="list" class="pb-2 gap-5 grid md:grid-cols-2 xl:grid-cols-3 mt-8">
      ...
      >
        <div
          class="reading-list-link relative flex min-w-0 group items-baseline space-x-3 flex-1 border border-gray-300 rounded shadow-hard bg-oc-yellow-2 hover:bg-oc-yellow-3 focus-within:bg-oc-yellow-3 p-4 font-serif"
        >
          <img
            :src="item.favicon"
      ...
      >
        ...
        <div
          class="reading-list-link relative flex min-w-0 group items-baseline space-x-3 flex-1 border border-gray-300 rounded shadow-hard bg-oc-yellow-2 hover:bg-oc-yellow-3 focys-within:bg-oc-yellow-3 p-4 font-serif"
        >
