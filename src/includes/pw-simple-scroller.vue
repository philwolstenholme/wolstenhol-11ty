<template>
  ...
  >
    <button
      ...
      class="group -left-12 absolute bottom-5 top-0 w-8 transition-opacity duration-300"
      x-bind:class="{
    ...
    <button
      ...
      class="group -right-12 absolute bottom-5 top-0 w-8 transition-opacity duration-300"
      x-bind:class="{
